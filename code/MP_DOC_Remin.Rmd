...
DOM_remin <- read_csv(here("data", "DOM_remineralization.csv"))
...
DOM_amendment_bioavailability_metadata %>% 
  summarize(mean_recalc = mean(recalcitrant_percent),
            sd_recalc = sd(recalcitrant_percent))
