...
MP_age_data_sum <- read_xlsx("MP_Exudate_age_230809.xlsx", sheet = 1)

MP_DOC_NPP_phys_env_sum <- read_xlsx("MP_Exudate_age_230809.xlsx", sheet = 4)

MP_DOC_NPP_phys_env_sum_noflags  <- MP_DOC_NPP_phys_env_sum %>% 
  filter(flag != 2)

MP_DOM_Sugar <- read_xlsx("MP_Exudate_age_230809.xlsx", sheet = 3) 

MP_DOM_character <- read_xlsx("MP_Exudate_age_230809.xlsx", sheet = 2)
